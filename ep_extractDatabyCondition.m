...
cond_order = [3 2 4 3 1 2 4 2 1 4 3 1 5 5 6 6 7 7]; %s115 (runs 1 and 18 were bad so I delete them below)
...
data_scramble = cell(nROIs,1);
data_control = cell(nROIs,1);
...
for ROI = 1:nROIs
    ...
    %For s115 ONLY, remove bad extra runs
    if subject == 115
        ROIdata(:,[1:nTRs 2517:2664]) = [];
    end
